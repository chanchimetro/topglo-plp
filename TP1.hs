...
subCircuitoMásResistente =
  recCircuito
    Caja
    ( \circ1 circ2 recCirc1 recCirc2 ->
        if resistenciaCircuito recCirc1 > resistenciaCircuito recCirc2
          then
            if resistenciaCircuito (Serie circ1 circ2) > resistenciaCircuito recCirc1
              then Serie circ1 circ2
              else recCirc1
          else
            if resistenciaCircuito (Serie circ1 circ2) > resistenciaCircuito recCirc2
              then Serie circ1 circ2
              else recCirc2
    )
    ( \caja1 circ1 circ2 caja2 _ recCirc1 recCirc2 _ ->
        if resistenciaCircuito recCirc1 > resistenciaCircuito recCirc2
          then
            if resistenciaCircuito (Paralelo caja1 circ1 circ2 caja2) > resistenciaCircuito recCirc1
              then Paralelo caja1 circ1 circ2 caja2
              else recCirc1
          else
            if resistenciaCircuito (Paralelo caja1 circ1 circ2 caja2) > resistenciaCircuito recCirc2
              then Paralelo caja1 circ1 circ2 caja2
              else recCirc2
    )
